    ...
    try:
        ...
        return jsonify({
            ...
            "data": {
                ...
                "public_key": base64.b64encode(result.get('public_key', b'')).decode('utf-8'),
                "algorithm": algorithm,
...
def hybrid_encrypt():
    ...
    try:
        ...
        return jsonify({
            "success": True,
            "data": {
                "ciphertext": base64.b64encode(result.get('ciphertext', b'')).decode('utf-8'),
                "algorithm": algorithm,
...
def health_check():
    ...
    return jsonify({
        ...
        "algorithms_supported": ["kyber512", "kyber768", "kyber1024", "dilithium2", "dilithium3"] if QUANTUM_AVAILABLE else []
    }), 200
