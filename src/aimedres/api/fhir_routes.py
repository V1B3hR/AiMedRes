    ...
    def _initialize_mock_patients(self) -> Dict[str, Any]:
        ...
        return {
            "patient-001": {
                ...
                "id": "patient-001",
                "identifier": [
                    {"system": "urn:oid:1.2.36.146.595.217.0.1", "value": "PAT-001-DEIDENTIFIED"}
                ],
                "name": [{"use": "official", "family": "REDACTED", "given": ["REDACTED"]}],
                "gender": "male",
                "birthDate": "1950-01-15",
                "address": [
                    {"use": "home", "city": "REDACTED", "state": "CA", "postalCode": "REDACTED"}
                ],
                "active": True,
            },
            "patient-002": {
                ...
                "id": "patient-002",
                "identifier": [
                    {"system": "urn:oid:1.2.36.146.595.217.0.1", "value": "PAT-002-DEIDENTIFIED"}
                ],
                "name": [{"use": "official", "family": "REDACTED", "given": ["REDACTED"]}],
                "gender": "female",
            ...
            "patient-003": {
                ...
                "id": "patient-003",
                "identifier": [
                    {"system": "urn:oid:1.2.36.146.595.217.0.1", "value": "PAT-003-DEIDENTIFIED"}
                ],
                "name": [{"use": "official", "family": "REDACTED", "given": ["REDACTED"]}],
                "gender": "female",
...
def list_fhir_patients():
    ...
    try:
        ...
        bundle = {
            ...
            "total": len(patients),
            "entry": [
                {"resource": patient, "fullUrl": f"Patient/{patient['id']}"} for patient in patients
            ],
        }
